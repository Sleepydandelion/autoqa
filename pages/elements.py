...
class Elements(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.text_m = WebElement(driver, '#app > div > div > div.row > div.col-12.mt-4.col-md-6')
        ...
        self.btn_sidebar_first_textbox = WebElement(driver, 'div:nth-child(1) > div > div > ul > #item-0 > span')
        self.btn_sidebar_first_checkbox = WebElement(driver, 'div:nth-child(1) > div > div > ul > #item-1 > span')
